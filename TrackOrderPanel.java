...
public class TrackOrderPanel extends JPanel {
    ...
    private void showWelcomeMessage() {
        ...
        welcomeCard.setMaximumSize(new Dimension(500, 280));
        
        JLabel iconLabel = new JLabel("📦");
        iconLabel.setFont(new Font("Segoe UI", Font.PLAIN, 56));
        iconLabel.setAlignmentX(Component.CENTER_ALIGNMENT);
        welcomeCard.add(iconLabel);
        ...
        welcomeCard.add(Box.createVerticalStrut(5));
    ...
    private void showRecentOrdersList() {
        ...
        if (!userOrders.isEmpty()) {
            ...
            emptyIcon.setFont(new Font("Segoe UI", Font.PLAIN, 42));
    ...
    private void showMyRecentOrders() {
        ...
        if (!userOrders.isEmpty()) {
            ...
            emptyCard.setAlignmentX(Component.CENTER_ALIGNMENT);
            emptyCard.setMaximumSize(new Dimension(400, 200));
    ...
    private void showOrderNotFound(String trackingNumber) {
        ...
        notFoundCard.add(Box.createVerticalStrut(5));
    ...
    private void showUnauthorizedMessage() {
        ...
        unauthorizedCard.setMaximumSize(new Dimension(450, 200));
        unauthorizedCard.setBackground(new Color(255, 248, 225));
        
        JLabel iconLabel = new JLabel("🔒");
        iconLabel.setFont(new Font("Segoe UI", Font.PLAIN, 52));
        iconLabel.setAlignmentX(Component.CENTER_ALIGNMENT);
        unauthorizedCard.add(iconLabel);
        ...
        unauthorizedCard.add(Box.createVerticalStrut(8));
    ...
    private void displayOrderTrackingDetails(SenderOrder order) {
        ...
        // Visual Timeline
        trackingResultPanel.add(createVisualTimeline(order));
        trackingResultPanel.add(Box.createVerticalStrut(20));
        ...
        leftColumn.add(createAddressPanel(order));
        leftColumn.add(Box.createVerticalStrut(15));
        leftColumn.add(createPackageDetailsPanel(order));
        
        // Right column components
        rightColumn.add(createCostBreakdownPanel(order));
        rightColumn.add(Box.createVerticalStrut(15));
        rightColumn.add(createPaymentDetailsPanel(order));
        
        twoColumnPanel.add(leftColumn);
        twoColumnPanel.add(rightColumn);
        trackingResultPanel.add(twoColumnPanel);
        trackingResultPanel.add(Box.createVerticalStrut(15));
        
        // Shipping info and driver details (full width)
        trackingResultPanel.add(createShippingInfoPanel(order));
    ...
    private JPanel createEnhancedStatusHeader(SenderOrder order) {
        ...
        // Status icon
        JLabel statusIcon = new JLabel(getStatusIcon(order.getStatus()));
    ...
    private JPanel createVisualTimeline(SenderOrder order) {
        ...
        timelinePanel.setMaximumSize(new Dimension(Integer.MAX_VALUE, 300));
    ...
    private JPanel createTimelineStep(String title, String description, String timestamp, 
        ...
        stepPanel.setBorder(BorderFactory.createEmptyBorder(8, 10, 8, 20));
        
        JPanel leftPanel = new JPanel(new BorderLayout());
        leftPanel.setOpaque(false);
        leftPanel.setPreferredSize(new Dimension(50, 40));
        ...
        if (step < totalSteps) {
            ...
            connectorLabel.setFont(new Font("Segoe UI", Font.PLAIN, 12));
        ...
        titleLabel.setFont(new Font("Segoe UI", (completed || current) ? Font.BOLD : Font.PLAIN, 13));
    ...
    private JPanel createCostBreakdownPanel(SenderOrder order) {
        ...
        costPanel.setMaximumSize(new Dimension(Integer.MAX_VALUE, 180));
        ...
        if (insuranceCost > 0) {
            gbc.gridx = 0;
            gbc.gridy = row;
            JLabel insuranceLabel = new JLabel("🛡️ Insurance Cost:");
    ...
    private JPanel createPaymentDetailsPanel(SenderOrder order) {
        ...
        paymentPanel.setMaximumSize(new Dimension(Integer.MAX_VALUE, 160));
    ...
    private JPanel createShippingInfoPanel(SenderOrder order) {
        ...
        shippingPanel.setMaximumSize(new Dimension(Integer.MAX_VALUE, 100));
    ...
    private JPanel createAddressPanel(SenderOrder order) {
        ...
        fromPanel.setBorder(BorderFactory.createEmptyBorder(8, 8, 8, 8));
        ...
        JLabel fromAddress = new JLabel("<html><div style='width: 220px; font-size: 11px;'>" + 
        ...
        toPanel.setBorder(BorderFactory.createEmptyBorder(8, 8, 8, 8));
        ...
        JLabel toAddress = new JLabel("<html><div style='width: 220px; font-size: 11px;'>" + 
    ...
    private JPanel createPackageDetailsPanel(SenderOrder order) {
        ...
        packagePanel.setMaximumSize(new Dimension(Integer.MAX_VALUE, 160));
    ...
    private JPanel createDriverDetailsPanel(SenderOrder order) {
        ...
        driverPanel.setMaximumSize(new Dimension(Integer.MAX_VALUE, 130));
