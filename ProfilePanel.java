...
public class ProfilePanel extends JPanel {
    ...
    private JPanel createSecurityPanel() {
        ...
        gbc.gridx = 0; gbc.gridy = 0;
        gbc.gridwidth = 2;
        JLabel passwordSection = new JLabel("Change Password");
        passwordSection.setFont(new Font("Segoe UI", Font.BOLD, 16));
        passwordSection.setForeground(new Color(0, 123, 255));
        panel.add(passwordSection, gbc);
        ...
        strengthBar.setFont(new Font("Segoe UI", Font.PLAIN, 10));
        ...
        gbc.gridwidth = 2;
        gbc.insets = new Insets(20, 10, 10, 10);
        JButton updateBtn = createStyledButton("Update Password", new Color(0, 123, 255), Color.WHITE);
        updateBtn.addActionListener(e -> {
            ...
            if (newPass.isEmpty()) {
                JOptionPane.showMessageDialog(panel, "Please enter a new password.", "Error", JOptionPane.ERROR_MESSAGE);
        ...
        JLabel twoFALabel = new JLabel("Two-Factor Authentication");
        twoFALabel.setFont(new Font("Segoe UI", Font.BOLD, 16));
        twoFALabel.setForeground(new Color(0, 123, 255));
        panel.add(twoFALabel, gbc);
        
        gbc.gridy = 7;
        JPanel twoFAPanel = new JPanel(new FlowLayout(FlowLayout.LEFT));
        twoFAPanel.setBackground(Color.WHITE);
        JCheckBox twoFACheckbox = new JCheckBox("Enable Two-Factor Authentication");
        twoFACheckbox.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        JButton setup2FABtn = createStyledButton("Setup", new Color(0, 123, 255), Color.WHITE);
        setup2FABtn.setFont(new Font("Segoe UI", Font.PLAIN, 12));
        twoFAPanel.add(twoFACheckbox);
        twoFAPanel.add(setup2FABtn);
        panel.add(twoFAPanel, gbc);
